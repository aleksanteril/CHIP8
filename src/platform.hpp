...
class Platform
{
      public:
        ...
        virtual void draw_screen(std::array<bool, 64 * 32>& buffer, struct CPU_State state) = 0;
...
class SDL3 : public Platform
{
      public:
        ...
        void draw_screen(std::array<bool, 64 * 32>& buffer, struct CPU_State state) override;
